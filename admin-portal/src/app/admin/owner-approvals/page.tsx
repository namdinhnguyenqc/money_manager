      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex rounded-lg border border-slate-200 bg-white p-1">
              <button
                ...
                className={`rounded-md px-3.5 py-1.5 text-xs font-bold transition-all ${
                  filterStatus === "PENDING_APPROVAL" ? "bg-slate-900 text-white shadow-sm" : "text-slate-600 hover:text-slate-955"
                }`}
              >
                Chờ duyệt
              </button>
            ...
            <button onClick={load} className="inline-flex items-center gap-2 rounded-[8px] border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex justify-end gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-[8px] border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-700 hover:bg-slate-50"
                          >
                            <Eye size={15} />
                            Xem
                          </button>
                          {filterStatus === "PENDING_APPROVAL" && (
                            <>
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-[8px] bg-emerald-600 px-3 py-2 text-xs font-bold text-white hover:bg-emerald-700 disabled:opacity-60"
                              >
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-[8px] bg-red-600 px-3 py-2 text-xs font-bold text-white hover:bg-red-700 disabled:opacity-60"
                              >
                                <XCircle size={15} />
                                Từ chối
                              </button>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      >
                        ...
                        <span className={`text-[10px] leading-relaxed whitespace-pre-line ${selectedPlan === "basic" ? "text-slate-300" : "text-slate-500"}`}>
                      ...
                      >
                        ...
                        <span className={`text-[10px] leading-relaxed whitespace-pre-line ${selectedPlan === "premium" ? "text-slate-800" : "text-slate-500"}`}>
