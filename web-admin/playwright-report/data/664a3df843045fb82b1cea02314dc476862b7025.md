...
- Name: owner-rental-billing-flow.spec.ts >> Owner rental billing flow >> regression: contract form blocks invalid tenant identity without runtime crash
- Location: tests/e2e/owner-rental-billing-flow.spec.ts:82:3
...
Call log:
  - waiting for getByRole('button', { name: /Thêm phòng/i })
