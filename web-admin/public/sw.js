...
const PRECACHE_URLS = [
  ...
  "/brand/app-icons/app-icon-white-256.png",
  "/brand/app-icons/app-icon-white-512.png",
];
...
self.addEventListener("push", (event) => {
  ...
  const options = {
    body: data.body || "",
    icon: data.icon || "/brand/app-icons/app-icon-white-256.png",
    badge: "/brand/app-icons/app-icon-white-64.png",
