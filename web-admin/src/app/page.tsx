...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/brand/transparent/trocare-logo-full-transparent-2000.png",
        width: 2000,
        height: 612,
        alt: "Logo TroCare quản lý trọ thông minh",
      },
    ],
  },
  twitter: {
    ...
    images: ["/brand/transparent/trocare-logo-full-transparent-2000.png"],
  },
};
